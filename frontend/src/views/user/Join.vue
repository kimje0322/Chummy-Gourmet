...
<template>
  <div class="entire">
    ...
    <div class="form-wrap">
      ...
      <div class="input-with-label">
        <input v-model="signupData.nickName" id="nickname" placeholder="닉네임을 입력하세요." type="text" />
        <label for="nickname">닉네임</label>
        <div class="error-text" v-if="error.nickName">{{error.nickName}}</div>
      </div>

      <div class="input-with-label">
        <input v-model="signupData.email" id="email" placeholder="이메일을 입력하세요." type="text" />
...
export default {
  ...
  methods: {
    ...
    //   axios
    //     .post(`${SERVER_URL}/account/signup/`, {
    //       name,
    //       password,
    //       email,
    //       nickName,
