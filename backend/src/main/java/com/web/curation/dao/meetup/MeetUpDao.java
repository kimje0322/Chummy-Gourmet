...
public interface MeetUpDao extends JpaRepository<Meetup, String> {
	...
	@Query(value = "SELECT meetup_id,user_name AS meetup_master, meetup_title, meetup_content,meetup_location,meetup_address,meetup_date,meetup_create_date, meetup_personnel " + 
			"FROM meetup a " + 
